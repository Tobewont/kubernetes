...
```bash
kubectl exec zk-0 -n public-service -- cat /var/lib/zookeeper/data/myid
1

kubectl exec zk-1 -n public-service -- cat /var/lib/zookeeper/data/myid
2

kubectl exec zk-2 -n public-service -- cat /var/lib/zookeeper/data/myid
3
```
...
```bash
kubectl exec zk-0 -n public-service -- zkCli.sh create /hello world
...
kubectl exec zk-2 -n public-service -- zkCli.sh get /hello
